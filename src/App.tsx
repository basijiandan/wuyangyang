...
const defaultArtifacts: Artifact[] = [
  ...
  },
  {
    ...
    metalColor: 0xd4af37,
    roughness: 0.25,
    modelPath: "/models/weiyang_shengxiao.glb"
  },
  {
    id: "hongwu_tongbao",
    title: "洪武通宝背马牛羊花钱",
    ...
    metalColor: 0xb87333,
    roughness: 0.4,
    modelPath: "/models/hongwu_tongbao.glb"
  },
  {
    id: "guangdong_wuyang",
    title: "广东五羊壹仙铜币",
    ...
    metalColor: 0xa0522d,
    roughness: 0.3,
    modelPath: "/models/guangdong_wuyang.glb"
  },
  {
    id: "sanyang_kaitai",
    title: "三阳开泰花钱",
    ...
    metalColor: 0xffd700,
    roughness: 0.2,
    modelPath: "/models/sanyang_kaitai.glb"
  },
  {
    id: "coin_2003_comm",
    title: "2003癸未羊年普通纪念币",
    ...
    metalColor: 0xe5e4e2,
    roughness: 0.15,
    modelPath: "/models/coin_2003_comm.glb"
  },
  {
    id: "silver_2003_1oz",
    ...
    metalColor: 0xffffff,
    roughness: 0.1,
    modelPath: "/models/silver_2003_1oz.glb"
  },
  {
    id: "coin_2015_comm",
    title: "2015乙未羊年普通纪念币",
    era: "现代 (公元2015年2月发行)",
    size: "直径 27.0 mm | 厚度 2.1 mm",
    material: "双色铜合金 (Bi-metallic Alloy)",
    textures: "正面国徽与面值，背面三羊开泰剪纸风格图案及「乙未」干支纪年。",
    description: "乙未羊年生肖普通纪念币，粒子重构其双金属环带与三羊剪纸浮雕层次。",
    color1: [0.92, 0.82, 0.40],
    color2: [0.75, 0.78, 0.82],
    mathType: "modern_comm",
    metalColor: 0xe5e4e2,
    roughness: 0.15,
    modelPath: "/models/coin_2015_comm.glb"
  },
  {
    id: "neimenggu_40",
    title: "内蒙古自治区成立40周年纪念币",
    era: "现代 (公元1987年发行)",
    size: "直径 30.0 mm | 厚度 2.0 mm",
    material: "铜镍合金 (Cupronickel)",
    textures: "正面国徽，背面蒙古包、骏马与「内蒙古自治区成立四十周年」铭文。",
    description: "纪念自治区成立四十周年之流通纪念币，粒子凝练草原穹庐与骏马图腾。",
    color1: [0.85, 0.88, 0.92],
    color2: [0.35, 0.45, 0.55],
    mathType: "modern_comm",
    metalColor: 0xc0c0c0,
    roughness: 0.2,
    modelPath: "/models/neimenggu_40.glb"
  },
  {
    id: "xinjiang_30",
    title: "新疆维吾尔自治区成立30周年纪念币",
    era: "现代 (公元1985年发行)",
    size: "直径 30.0 mm | 厚度 2.0 mm",
    material: "铜镍合金 (Cupronickel)",
    textures: "正面国徽，背面葡萄串、天山雪峰与「新疆维吾尔自治区成立三十周年」铭文。",
    description: "纪念自治区成立三十周年之流通纪念币，粒子再现丝路葡萄与雪峰意象。",
    color1: [0.85, 0.88, 0.92],
    color2: [0.45, 0.55, 0.65],
    mathType: "modern_comm",
    metalColor: 0xc0c0c0,
    roughness: 0.2,
    modelPath: "/models/xinjiang_30.glb"
  }
];
...
export default function App() {
  ...
  const buildParticlePositionsFromVertices = (vertices: number[]) => {
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (event: any) => {
      try {
        ...
        const paddedArray = buildParticlePositionsFromVertices(vertices);
